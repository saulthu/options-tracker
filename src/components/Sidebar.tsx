...
import { Plus, Grid3X3, Calendar, Activity, TrendingUp, Brain, Settings, User, LogOut, LucideIcon, List, Building2, BarChart3 } from "lucide-react";
...
export default function Sidebar({ children, onViewChange, currentView, onLogout, userProfile }: SidebarProps) {
  ...
  const navItems = [
    ...
    { key: 'market-data-demo', icon: BarChart3, text: 'Market Data', hasAction: true },
        ...
        <div className="border-b border-[#2d2d2d] py-4 px-2">
          <div className="flex items-center">
            <div className="w-12 h-12 flex items-center justify-center cursor-pointer" onClick={toggleSidebar}>
              <Image src="/gt-256.png" alt="GT Logo" width={48} height={48} quality={85} className="object-contain" />
            </div>
          </div>
        </div>
